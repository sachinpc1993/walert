...
class CoursesIntentHandler(AbstractRequestHandler):
    ...
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return ask_utils.is_intent_name("BSE_BESE")(handler_input)

    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        response_variations = ["Bachelor of Software Engineering students learn to design, build and maintain software solutions through industry-led learning and a 1-year internship, honing their skills to meet stakeholder needs. Meanwhile, Bachelor of Engineering in Software Engineering is a degree that combines engineering practices and embedded systems, with a focus on programming for sensors, IoT devices, and digital electronics. It includes a research component, which takes up less time for industry practice.",
        "Bachelor of Software Engineering graduates are more specialized in software design and development, whereas Bachelor of Engineering in Software Engineering graduates have a broader range of skills in engineering and embedded systems."]
